...
from .filters import filter_markdown_for_pdf_export


DEFAULT_INPUT = "_脚本/outputs/中间文件/01_完整合并/Decathlon_VOC_Analyzer_Complete_Paper.md"
...
def render_pdf(html_path: Path, pdf_path: Path) -> None:
    try:
        ...
        raise RuntimeError("未找到 weasyprint，请先安装 weasyprint 后再导出 PDF。") from exc
