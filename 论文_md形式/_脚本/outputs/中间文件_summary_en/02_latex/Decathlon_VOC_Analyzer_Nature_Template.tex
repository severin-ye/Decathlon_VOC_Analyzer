...
Conventional review summarization / ABSA
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
Proposed system
\end{minipage} \\
\midrule\noalign{}
...
\subsection{Evidence Scoring and Reranking}
