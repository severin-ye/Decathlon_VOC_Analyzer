...
from decathlon_voc_analyzer.stage1_dataset.chinese_dataset_service import ChineseDatasetService
...
def main() -> None:
    ...
    parser.add_argument(
        "--source-root",
        default="01_data/01_raw_products/products",
        help="原始数据集根目录，默认 01_data/01_raw_products/products",
    )
    parser.add_argument(
        "--output-root",
        default="01_data/02_audit_zh_products/products",
        help="中文审核数据集输出根目录，默认 01_data/02_audit_zh_products/products",
    )
