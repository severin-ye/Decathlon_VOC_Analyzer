...
DEFAULT_INPUT = "CuraView_Complete_Paper.md"
DEFAULT_OUTPUT = "outputs/中间文件/02_latex/CuraView_Nature_Template.tex"
...
def build_author_tabular_latex(author_blocks: list[AuthorBlock], max_cols: int = 4) -> str:
    ...
    cols = min(max_cols, max(1, len(blocks)))
    # 为 tabular 列间距预留空间，避免作者块整体超出页宽。
    col_width = 0.88 / cols
