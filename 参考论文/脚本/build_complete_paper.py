...
DEFAULT_OUTPUT = "CuraView_Complete_Paper.md"

# 标题页已提取为可编辑分章文件：title_page.md
# 若不希望合并时包含标题页，可使用参数：--no-title-page
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="按分章 Markdown 自动合并生成完整稿。")
    parser.add_argument(
        "--section-dir",
        default=None,
